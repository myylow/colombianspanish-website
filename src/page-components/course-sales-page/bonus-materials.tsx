...
const BonusMaterials = () => {
  ...
  const quotesJsx = displayedQuotes.map((it) => {
    ...
    return (
      <li
        key={it.caption}
        className={`flex container absolute flex-col items-center opacity-0 mx-auto left-0 right-0 transition-opacity duration-1000 ${selectedClass}`}
      >
        <q className="font-light italic text-xl md:text-2xl text-gray-500 max-w-2xl text-center mt-4 mb-2">
          “{it.quote}”
        </q>
  ...
  return (
    <>
      <section>
        <h2 className="container text-center">Bonus materials to boost your learning</h2>
        <div className="flex flex-col md:flex-row container max-w-3xl mx-auto mt-12 items-center justify-items-center">
          <div>
            <NextImage src="/components/course/ebook.png" width={360} height={227} />
          </div>
          <div className="mt-8 md:mt-0 md:ml-12 max-w-sm">
        ...
        <div className="quote my-12 bg-gray-100 py-8">
          <div>
            <h4 className="text-center container uppercase text-gray-500 font-semibold text-lg">
              What customers say about the Colombian Spanish eBook
            </h4>
            <ul className="relative mb-12 h-32 md:h-28 container">{quotesJsx}</ul>
            <ul className="flex mx-auto items-center justify-between max-w-xs md:max-w-sm">
              {dotsJsx}
            </ul>
          </div>
        </div>
        <div className="max-w-3xl mx-auto container flex flex-col-reverse md:flex-row-reverse items-center">
          <img src="/components/course/flashcards.png" className="img" />
          <div className="md:pr-20 pb-8 md:pb-0">
        ...
        <div className="text-center my-8 md:my-16 text-blue-500 text-2xl">
      ...
      >
        <div className="overlay-bodx max-w-2xl text-lg text-gray-700 mx-auto bg-white rounded-sm px-8 md:px-16 py-12 border border-gray-300 shadow-lg">
          <h2 className="text-center px-12 md:px-0">With you every step of the way</h2>
          <p>
