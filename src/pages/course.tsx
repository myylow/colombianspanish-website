...
import VideoOverlay from '../page-components/course-sales-page/video-overlay'
import CourseFeatures from '../page-components/course-sales-page/course-features'
import CourseInstructor from '../page-components/course-sales-page/course-instructor'
import BonusMaterials from '../page-components/course-sales-page/bonus-materials'
import CourseSyllabus from '../page-components/course-sales-page/course-syllabus'
import GetStartedNow from '../page-components/course-sales-page/get-started-now'
import Faq from '../page-components/course-sales-page/faq'
import CourseHeader from '../shared-components/header'
